/* =====================================================
   PROJECT BIM — TRANSLATIONS
   Pablo Boggetti Portfolio
===================================================== */
...
const translations = {
  es: {
    ...
    heroTitle:
      "Modelado BIM de una Subestación Eléctrica de 132 kV",
    ...
    /* 01 — Proyecto */
    contextNumber: "01 · El proyecto",

    contextTitle:
      "Representación digital de una instalación eléctrica",
    ...
    objectiveTitle:
      "Desarrollar un modelo BIM organizado y navegable",
    ...
    galleryTitle:
      "Imágenes del proceso y del resultado",
    ...
    overviewCaption:
      "Vista superior de la implantación",

    beforeAfterCaption:
      "Comparación entre referencia y modelo",
    ...
    workspaceCaption:
      "Entorno de modelado en Autodesk Revit",

    sheetCaption:
      "Lámina preparada desde el modelo",

    /* 05 — Flujo de trabajo */
    workflowNumber: "05 · Flujo de trabajo",

    workflowTitle:
      "Proceso utilizado para desarrollar el modelo",
  ...
  en: {
    ...
    /* Hero */
    heroEyebrow:
      "Electrical engineering · Autodesk Revit · BIM methodology",

    heroTitle:
      "BIM Modeling of a 132 kV Electrical Substation",
    ...
    /* 01 — Project */
    contextNumber: "01 · The project",

    contextTitle:
      "Digital representation of an electrical installation",

    contextParagraph1:
      "Electrical substations include equipment and structures that must be correctly located and related within the installation. Three-dimensional modeling improves the spatial understanding of the project.",
    ...
    objectiveTitle:
      "Develop an organized and navigable BIM model",
    ...
    galleryTitle:
      "Process and result images",

    galleryIntroduction:
      "General views, details and documentation obtained from the model developed in Autodesk Revit.",

    galleryCaption1:
      "General view of the substation",

    overviewCaption:
      "Top view of the site layout",

    beforeAfterCaption:
      "Comparison between reference information and model",
    ...
    workspaceCaption:
      "Autodesk Revit modeling environment",

    sheetCaption:
      "Sheet prepared from the model",
    ...
    result2Description:
      "Clearer understanding of the location and relationship between equipment and structures.",
    ...
    result4Description:
      "Model prepared for additional information to be incorporated when required.",
